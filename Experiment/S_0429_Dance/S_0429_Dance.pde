...
void setup()
{
  ...
  actionToRecord = new Action(300);
  actionLoaded = new Action();
  currentFileName = "dance_int.txt";
...
void draw()
{
  ...
  {  
    ...
    if (filename != null)
    {
      ...
      actionLoaded.load(currentFileName);
      currentFileName = "dance_loop.txt";
    }
    // for Fight
    else if (actionLoaded.currentIdx == 0)
    {
      actionLoaded = new Action();
      actionLoaded.load(currentFileName);
      if (currentFileName.equals("dance_loop.txt"))
        currentFileName = "dance_invite.txt";
      else
        currentFileName = "dance_loop.txt";
    }
